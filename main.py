...
info_column = sg.Column([
	[sg.Text('', key = '-LOCATION-', font = 'Calibri 30', background_color = '#F9AA33', pad = 0, visible = False)],
	[sg.Text('', key = '-TIME-', font = 'Calibri 16', background_color = '#FFFFFF', text_color = '#344955', pad = 0, visible = False)],
...
sg.theme('reddit')
window = sg.Window('Cloud Point', main_layout)
